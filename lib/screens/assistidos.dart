...
class Assistidos extends StatefulWidget {
  const Assistidos({Key? key}) : super(key: key);

  @override
  State<Assistidos> createState() => _AssistidosState();
}

class _AssistidosState extends State<Assistidos> {
          ...
          children: [
            CardItem(
               Text("${categorias![index].animes!.nome}"),
                            Text("Categoria: ${categoriass[index].codigo}")
            ),
          ]
      ),
