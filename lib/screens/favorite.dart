...
import 'package:mobileapp/screens/assistindo.dart';
import 'package:mobileapp/screens/mainpage.dart';
import 'package:mobileapp/screens/profile.dart';
import 'package:mobileapp/screens/quero.dart';
import 'package:mobileapp/screens/search.dart';
import 'package:mobileapp/screens/assistidos.dart';
...
class _FavoriteState extends State<Favorite> {
  _SelectedTab _selectedTab = _SelectedTab.likes;
      ...
      body: Container(
        ...
        child: ListView(
            ...
            child: FutureBuilder<List<Categorias>>(
              future: CategoriaDAO().getCategorias(),
              initialData: [],
          ...
          children: [
            CardItem(
               Text("${categorias![index].animes!.nome}"),
                            Text("Categoria: ${categorias[index].codigo}")
            ),
          ]
      ),
          ...
          Expanded(
            ...
            child: Container(
              ...
              child: IconButton(
                ...
                onPressed: onPressed, // Utiliza o onPressed definido no construtor
              ),
            ),
          ),
          Expanded(
